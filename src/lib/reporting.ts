...
export const REPORT_TEMPLATES: ReportTemplate[] = [
  {
    ...
    description:
      "Synthèse technique pour la direction risques : portfolio, calcul IRAX-D, alertes critiques.",
    recipient: "Direction des Risques",
    sections: [
      "Synthèse exécutive",
      "Distribution risque (IRAX-D)",
  ...
  },
  {
    ...
    description:
      "Rapport de démonstration bout-en-bout : timeline du dossier céréales Meknès, preuves d'intégrité horodatées, calcul IRAX-D, décision assureur. Source SEED_DEMO.",
    recipient: "Assureur / Investisseur",
    sections: [
      "Timeline du dossier complet",
      "Calcul IRAX-D — Indice 46.4 · MEDIUM_RISK",
